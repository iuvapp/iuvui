...
All components, including complex components, are free. Base styles and base variants are free. Pro focuses on maintained advanced Style Packs, premium visual variants, authenticated CLI source delivery and upgrades, MCP workflows, and team services. See [Commercial model](./docs/COMMERCIAL_MODEL.md).
